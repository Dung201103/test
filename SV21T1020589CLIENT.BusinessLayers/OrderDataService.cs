...
namespace SV21T1020589CLIENT.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        public static List<Order> ListOrderCustomer(int CustomerID)
        {
            return orderDB.ListOrder(CustomerID).ToList();
        }
        ...
        /// </summary>
        public static int InitOrder(int customerID, string deliveryProvince, string deliveryAddress, IEnumerable<OrderDetail> details)
        {
            if (details.Count() == 0)
                return 0;
            Order data = new Order()
            {
                ...
                Status = SV21T1020589CLIENT.DomainModels.Constants.ORDER_INIT
            };
